...
from ML_model.Utils.ASR.models import ASRCNN
from ML_model.Utils.JDC.model import JDCNet

from ML_model.Modules.diffusion.sampler import KDiffusion, LogNormalDistribution
from ML_model.Modules.diffusion.modules import Transformer1d, StyleTransformer1d
from ML_model.Modules.diffusion.diffusion import AudioDiffusionConditional

from ML_model.Modules.discriminators import (
...
def build_model(args, text_aligner, pitch_extractor, bert):
    ...
    if args.decoder.type == "istftnet":
        from ML_model.Modules.istftnet import Decoder
        ...
        from ML_model.Modules.hifigan import Decoder
